...
The database foreign key prevents subscriptions for missing users. Billing, renewal, cancellation, plan catalogs, expiry workers, and bandwidth enforcement are planned work rather than current behavior.
